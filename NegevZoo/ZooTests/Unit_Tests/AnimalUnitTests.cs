...
namespace ZooTests.Unit_Tests
{
    ...
    public class AnimalUnitTests
    {
        ...
        {
            Assert.AreEqual(3, context.GetAnimalsResults((int)Languages.ar).Count());
        }
        ...
        {
            Assert.AreEqual(2, context.GetAnimalResultsWithStory((int)Languages.ar).Count());
        }
        ...
        {
            Assert.AreEqual(1, context.GetAllAnimalStoriesResults((int)Languages.en).Count());
        }

        [TestMethod]
        public void GetAllAnimalStoryResultsLangAr()
        {
            Assert.AreEqual(1, context.GetAllAnimalStoriesResults((int)Languages.ar).Count());
        }
