...
namespace ZooTests.Unit_Tests
{
    ...
    public class EnclosureUnitTests
    {
        ...
        {
            var enc = context.GetEnclosureById(2, (int)Languages.he);
            ...
            //english
            enc = context.GetEnclosureById(1, (int)Languages.en);
            Assert.IsNotNull(enc);
        ...
        {
            var enc = context.GetEnclosureById(4, (int)Languages.en);
        ...
        {
            context.GetEnclosureById(400, (int)Languages.en);
        }
        ...
        {
            context.GetEnclosureById(1, nonExistantLang);
        }
        #endregion
        ...
        {
            IEnumerable<EnclosureResult> encs = context.GetEnclosureByName("תצוגת הקופים", 1);
            ...
            //english
            encs = context.GetEnclosureByName("Houman Monkeys", 2);
        ...
        {
            IEnumerable<EnclosureResult> encs = context.GetEnclosureByName("קרנף לבן", 2);
        ...
        {
            IEnumerable<EnclosureResult> encs = context.GetEnclosureByName("Monkeys", 2);
        ...
        {
            var encs = context.GetEnclosureByName("שימפנזות", (int)Languages.he);
        ...
        {
            context.GetEnclosureByName("Houman Monkeys", nonExistantLang);
        }
        #endregion
