app.controller('indexController', 
    ...
    function indexController($scope, $state, enclosureService, animalService) 
    {
        ...
        var allAnimalsQuery                 = animalService.getAllAnimals(1).then(function (data) { console.log('allAnimals', data); }, function (error) { console.log('allAnimalsFail', error); });
        ...
        var getAnimalByEnclosureQuery       = animalService.getAnimalsByEnclosure(1, 1).then(function (data) { console.log('gotAnimalByEnc', data); }, function (fail) { console.log('gotAnimalByEncFail', fail); });
        var getAnimalByNameQuery            = animalService.getAnimalByName('b', 2).then(function (data) { console.log('gotAnimalByName', data); }, function (fail) { console.log('gotAnimalByNameFail', fail); });
