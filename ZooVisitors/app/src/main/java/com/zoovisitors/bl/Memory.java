...
//    public static Point ZOO_ENTRANCE_POINT = new Point(1088, 1494);
// 1.5573580533024333719582850521437
//    private static Location ZOO_EXIT_LOCATION = new Location(31.25960466,34.74386817);
// -0.00154117
...
//                -
//                Math.abs(Math.atan2((ZOO_ENTRANCE_LOCATION.getLatitude() - ZOO_EXIT_LOCATION
// .getLatitude()) * getYLatitudeRatio(),
//                        (ZOO_ENTRANCE_LOCATION.getLongitude() - ZOO_EXIT_LOCATION.getLongitude
// ()) * getXLongitudeRatio()));
//    }
...
//    {
//        return (ZOO_ENTRANCE_POINT.getX() - ZOO_EXIT_POINT.getX()) / (ZOO_ENTRANCE_LOCATION
// .getLongitude() - ZOO_EXIT_LOCATION.getLongitude());
//    }
//    public static double getYLatitudeRatio()
//    {
//        // NOTE: be aware that the y axis are upside down in contrary to the points
//        return (ZOO_EXIT_POINT.getY() - ZOO_ENTRANCE_POINT.getY()) / (ZOO_ENTRANCE_LOCATION
// .getLatitude() - ZOO_EXIT_LOCATION.getLatitude());
//    }
...
//        Location turnedLocation = rotateLocationAroundEntrance
// (locationCenteredToEntranceReversed);
//        Location locationCenteredAndRatioed = scaleLocationToPoints(turnedLocation );
//
//        return new Point((int)locationCenteredAndRatioed.getLongitude() + ZOO_ENTRANCE_POINT
// .getX(),
//                (int)locationCenteredAndRatioed.getLatitude() + ZOO_ENTRANCE_POINT.getY());
//    }
//    @NonNull
//    private static Location calibrateLocationToEntranceAndReverseLongitudeAxis(Location
// location) {
...
// ZOO_ENTRANCE_LOCATION.getLatitude(),
...
//        return new Location(getYLatitudeRatio() * locationCenteredToEntranceReversed
// .getLatitude(),
